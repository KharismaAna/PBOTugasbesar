...
public class Register extends javax.swing.JFrame {
   Connection con;
    ...
    private void initComponents() {
        ...
        jPanel3.add(pfpass, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 190, 200, -1));
    ...
    private void btn_okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_okActionPerformed
        ...
        try{
           con = Koneksi.koneksiDB();
            String sql = "insert into register values('"+txtnama.getText()+ "','"+txtuser.getText()+"','"+pfpass.getText()+"','"+txtnohp.getText()+"','"+cbrole.getSelectedItem()+"','"+txtemail.getText()+"');";
